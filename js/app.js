...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let q3Sum = sum(sum(a, b)[0], c)[0];
  let q3Product = multiply(multiply(a, b)[0], c)[0];
  let q3SumString = `${a} and ${b} and ${c} sum to ${q3Sum}.`;
  let q3ProductString = `The product of ${a} and ${b} and ${c} is ${q3Product}.`;

  return [q3Sum, q3Product, q3SumString, q3ProductString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (let i = 0; i < dynamicArray.length; i++) {
    product2 = multiply(product2, dynamicArray[i])[0];
  }

  let productString2 = `The numbers ${dynamicArray.join(',')} have a product of ${product2}.`;
  return [product2, productString2];
}
